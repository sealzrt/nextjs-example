...
export default class Other extends React.Component {
  ...
  static async getInitialProps(params) {
    console.log('1. Page Other >>> Other.getInitialProps()', Object.keys(params), `是否是服务端执行:${!process.browser}`);
    const {req} = params;
    if (req) {
      // 服务端
      return {
  ...
  constructor(props) {
    ...
    console.log('4. Page Other >>> constructor >> this.props', this.props);
    console.log(`4. Page Other >>> constructor >> 是否是服务端执行:${!process.browser}`);
  }

  render() {
    console.log('5. Page Other >>> render >> this.props', this.props);
    return <Page title="Other Page" linkTo="/"/>
  }
}